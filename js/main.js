...
const Vibor240 = document.getElementById("select20");
const Vibor241 = document.getElementById("select11");
const Vibor242 = document.getElementById("select12");
const Vibor243 = document.getElementById("select13");
const Vibor244 = document.getElementById("select14");
const Vibor245 = document.getElementById("select15");
const Vibor246 = document.getElementById("select16");
const Vibor247 = document.getElementById("select17");
const Vibor248 = document.getElementById("select18");
const Vibor249 = document.getElementById("select19");
...
btnResult2Node.addEventListener(`click`, function () {
    output9 = inputSSNode.value /100 * Vibor240.value
    output11 = inputcsNode.value /100 * Vibor241.value
    output12 = inputedaNode.value /100 * Vibor242.value
    output13 = inputgafNode.value /100 * Vibor243.value
    output14 = inputyaNode.value /100 * Vibor244.value
    output15 = inputiaNode.value /100 * Vibor245.value
    output16 = inputpapNode.value /100 * Vibor246.value
    output17 = input12Node.value /100 * Vibor247.value
    output18 = input13Node.value /100 * Vibor248.value
    output19 = input14Node.value /100 * Vibor249.value
    output21 = (output9 + output11 + output12 + output13 + output14 + output15 + output16 + output17 + output18 + output19);
